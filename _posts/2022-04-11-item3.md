...
해당 예시는 Thread의 아이디가 짝수이면 프로그램 초기화 시에 만들어진 객체를,
...
앞서 알아보았던 두 가지 방식은 역직렬화 시에 새로운 인스턴스가 만들어지는 문제점이 있습니다.
...
<br>
그렇다면 Singleton을 사용하면 어떤 장점이 있을까요?
